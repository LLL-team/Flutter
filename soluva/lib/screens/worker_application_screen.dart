    ...
    if (_formKey.currentState!.validate() &&
        (_facePhoto != null || _webImageBytes != null)) {
          ApiService.enviarSolicitudTrabajador(
            ...
            description: _certificationController.text.isNotEmpty ? _certificationController.text : null,
            facePhoto: _facePhoto,
            certifications: null, // Podrías agregar otro picker para certificaciones si es necesario
            token: '', // Aquí deberías obtener el token de autenticación si es necesario
          );
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Your application has been submitted for review.")),
      );
      Navigator.of(context).pop();
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Please fill all required fields and upload a photo.")),
      );
    }
  }
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Task Description (optional)'),
                maxLines: 4,
              ),
